...
<body>
 	<script>
 	    document.body.innerHTML += template('header', { list: ['卡片设计首页', '名片设计', '工牌设计', '会员卡设计', '在线客服'], Hlink: ['../../html/Card.htm', '../../html/MCard.htm', '../../html/NewPro/P_Card.htm', '../../html/NewPro/P_Card.htm'] });
