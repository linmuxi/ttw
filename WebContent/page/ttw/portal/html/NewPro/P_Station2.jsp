...
<body>
	 <script>
	     document.body.innerHTML += template('header', { list: ['建站营销', '标准类', '交易类', '电商类', 'UI设计', '在线客服'], Hlink: ['../../html/Station.htm', '../../html/NewPro/P_Station.htm', '../../html/NewPro/P_Station.htm', '../../html/NewPro/P_Station.htm', '../../html/NewPro/P_Station.htm'] });
