...
<body>
	   <script>
	       document.body.innerHTML += template('header', { list: ['项目案例', '定制网站', '网络架设', '微店建设', '淘宝店建设', '天猫店建设', 'UI设计'], Hlink: ['../../html/Project.html', '../../html/NewPro/P_Project.htm', '../../html/NewPro/P_Project.htm', '../../html/NewPro/P_Project.htm', '../../html/NewPro/P_Project.htm', '../../html/NewPro/P_Project.htm', '../../html/NewPro/P_Project.htm'] });
    ...
    <div class="Hbsj_Center">
        <div class="Hbsj_C_Top">
            ...
            <div class="Hbsj_C_T_Mer">
                <div class="Hbsj_C_T_M_Left">
                    <div class="Hbsj_C_T_M_Pic">
                        <img src="../../images/product/product.png" style=" margin: 21px;" />
                    </div>
                    <div class="Hbsj_C_T_M_Bot">
                        <div class="Hbsj_C_T_M_B_Sel">
                            <div class="Hbsj_C_T_M_B_Left"></div>
                            <div class="Hbsj_C_T_M_B_Div"></div>
                            <div class="Hbsj_C_T_M_B_Div"></div>
                            <div class="Hbsj_C_T_M_B_Div"></div>
                            <div class="Hbsj_C_T_M_B_Left" style="background-position:-141px -154px;"></div>
                        </div>
                    </div>
                </div>
                <div class="Hbsj_C_T_M_Right">
                    <div class="Hbsj_C_T_M_R_Top">
                        <div class="Hbsj_C_T_M_R_T_Left">
                            <div class="Hbsj_C_T_M_R_T_L_Text">海报设设计</div>
                    ...
                    <div class="Hbsj_C_T_M_R_T_Cen">
                        <div class="Hbsj_C_T_M_R_T_C_Top">
                            ...
                            <div class="Hbsj_C_T_M_R_T_C_T_Num"><font size="3">￥</font>1508.00</div>
                            <div class="Hbsj_C_T_M_R_T_C_T_Value">价格 ￥ 1900</div>
                        </div>
                        <div class="Hbsj_C_T_M_R_T_C_Cen Hbsj_C_T_M_R_T_C_Top">
                            <div class="Hbsj_C_T_M_R_T_C_C_Text">促销信息：<font color="#cc0000">满599.00另加59.00元，或满999.00另加109.00元，即可购买热销商品</font></div>
                        </div>
                        <div class="Hbsj_C_T_M_R_T_C_Bot Hbsj_C_T_M_R_T_C_Top">
                            <div class="Hbsj_C_T_M_R_T_C_B_Text">月销量：<font color="#cc0000">2655</font></div>
                    ...
                    <div class="Hbsj_C_T_M_R_T_Bot">
                        <div class="Hbsj_C_T_M_R_T_B_Num">
                            ...
                            <div class="Hbsj_C_T_M_R_T_B_N_Add">+</div>
                            <div class="Hbsj_C_T_M_R_T_B_N_Add" style=" border-bottom:0px; height:20px;">-</div>
                        </div>
                        <div class="Hbsj_C_T_M_R_T_B_N_Pay">立即购买</div>
                        <div class="Hbsj_C_T_M_R_T_B_N_Pay" style="background-color:#0096dc; color:white;">加入购物车</div>
            ...
            <div class="Hbsj_C_T_Cen">
                ...
                <div class="Hbsj_C_T_C_Right" style="height:1420px; border: solid 1px #c9c9c9;">
