...
<body data-spy="scroll" data-target=".subnav" data-offset-top="40">
	...
	<div class="navbar">
		<div class="navbar-innert">
			<a class="brand" href="#" style="color: #333333; width: 180px;"><img
				...
				<a class="brand" href="#">角色</a> <a class="brand2">角色列表</a>
		</div>
	</div>
	<div class="container-fluid containerb">
		...
		<div class="row-fluid">
			...
			<div class="span10">
				...
				<div class="line-dotted"></div>
				<!-- 提示框 -->
				<div id="roledelModal" class="modal hide fade">
				  ...
				  <div class="modal-footer">
				    <a href="#" id="rolebtnclose" class="btn">关闭</a>
				    <a href="#" id="rolebtnok" class="btn btn-primary">确认删除</a>
				  </div>
				</div>
			</div>
	...
	<script type="text/javascript"
		src="<%=basePath%>page/platform/js/role/roleList.js?1=2"></script>
