...
<body data-spy="scroll" data-target=".subnav" data-offset-top="40">
	...
	<!-- role dwr -->
	<script src="<%=basePath%>dwr/interface/SysAuthorityAction.js?2=1"></script>
	...
	<div class="navbar">
		<div class="navbar-innert">
			<a class="brand" href="#" style="color: #333333; width: 180px;"><img
				...
				<a class="brand" href="#">权限信息管理</a> <a class="brand2">编辑权限信息 </a>
		</div>
	</div>
		...
		<div class="row-fluid">
			...
			<div id="mainlogic" class="span10">
				<form name="authorityForm" id="authorityForm">
					...
					<!-- 开始显示用户form表单 -->
					<input type="hidden" id="authorityId" name="authorityId" value="${param.authorityId}"/>
					<div class="form-actions">
						<div class="form-inline">
							<span class="label label-required">权限标识:</span> 
							<input type="text" class="medium" id="authorityMark" name="authorityMark"/>
						</div>
						<div class="form-inline">
							<span class="label label-required">权限名称:</span> 
							<input type="text" class="medium" id="authorityName" name="authorityName"/>
						</div>
						<div class="form-inline">
							<span class="label label-required">提示信息:</span> 
							<input type="text" class="medium" id="message" name="message"/>
						</div>
						<div class="form-inline">
							<span class="label label-required">权限说明: </span> 
							<textarea rows="5" cols="200" class="medium" id="authorityDesc" name="authorityDesc"></textarea>
						</div>
						<div class="form-inline">
	...
	<script type="text/javascript"
		src="<%=basePath%>page/platform/js/authority/authority.js"></script>
